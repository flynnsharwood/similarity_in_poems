...
# Convert the poems to a list
poems = [poem1, poem2, poem3, poem4, poem5, poem6, poem7]

# Create a CountVectorizer object to create a list of word counts for each poem
vectorizer = CountVectorizer()

# Fit the vectorizer to the poems and transform them into vectors
...
print("similarity  in the form of a 7x7 matrix -")
print(similarity)
